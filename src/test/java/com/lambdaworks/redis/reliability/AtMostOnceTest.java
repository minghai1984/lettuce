...
public class AtMostOnceTest extends AbstractRedisClientTest {
    ...
    private Channel getChannel(RedisChannelHandler<?, ?> channelHandler) {
        ...
        DefaultEndpoint endpoint = (DefaultEndpoint) channelHandler.getChannelWriter();
    ...
    private Queue<Object> getCommandBuffer(RedisChannelHandler<?, ?> channelHandler) {
        ...
        if (channelHandler.getChannelWriter() instanceof DefaultEndpoint) {
            return (Queue) ((DefaultEndpoint) channelHandler.getChannelWriter()).getQueue();
        }
